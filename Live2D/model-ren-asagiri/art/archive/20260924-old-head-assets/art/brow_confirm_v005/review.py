...
for i,folder in enumerate(['brow_confirm_v004','brow_confirm_v005']):
 im=Image.open(ROOT/'art'/folder/'face_with_brows.jpg').crop((0,220,1080,1580)).resize((540,680))
 comparison.paste(im,(i*540,40));draw.text((i*540+18,8),'Previous' if i==0 else 'Revised',font=font,fill='white')
