...
def calibration():
    ...
    write(OUT/'calibration_verification.json',{'passed':True,'cases':metrics,'fixed_neck_checks':fixed,'scope':'v3/v4 same-input comparison isolates added knit folds. Fixed checks cover the face and top collar only; internal collar folds intentionally move. Belt comparison y850:1000 must match v3.'})
...
def build():
    ...
    primary=EXPORTS/'Risa_ModelOnly_ChestBreath_v4.mp4'
    breathing=EXPORTS/'Risa_ModelOnly_BreathOnly_v4.mp4'
    ...
    write(OUT/'manifest.json',{'primary':str(primary),'breath_only':str(breathing),
        ...
        'breathing_geometry':'v3 chest/shoulder warp retained. Body_Clothes adds ParamBreath 0/1 keys: three upper-knit vertices spread/tug down; three lower-knit vertices spread/tug up. Top collar, belt and head stay anchored; original texture unchanged.',
