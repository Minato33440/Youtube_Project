...
def main():
    ...
    run('-framerate', FPS, '-i', ROOT.parent / 'voice_sync_v1/frames/%05d.png',
        '-framerate', FPS, '-i', frames, '-i', audio,
        ...
        f"[both]drawtext={font}:text='V1 - amplitude':x=28:y=22:fontsize=26:fontcolor=white,drawtext={font}:text='V2 - phoneme timing':x=668:y=22:fontsize=26:fontcolor=white[v]",
    ...
    manifest = {
        ...
        'model': 'model/Risa_compat.model3.json', 'editor_model': '../voice_sync_v1/Risa_voice_test.cmo3',
        ...
        'mouth_driver': 'ParamMouthOpenY from aligned Japanese phones, phone-level energy and coarticulation',
        'alignment': 'alignment/phonemes.json',
