...
def main():
    ...
    configs=[('speaking','Risa_ModelOnly_ChestBreath_v1.mp4',479,main_indices),
             ('breath_only','Risa_ModelOnly_BreathOnly_v1.mp4',241,[0,30,60,90,120,180,240])]
    result={}
    ...
    # above the collar (crop y < 360) in all six calibration poses.
    face_errors=[]
    for i in range(6):
        ...
        face_errors.append(int(np.abs(a[:360]-b[:360]).max()))
