...
OLD_RIG=OUT.parent/'chest_breath_v1/Risa_chest_breath.model3.json'
...
def build():
    ...
    primary=EXPORTS/'Risa_ModelOnly_ChestBreath_v2.mp4'
    breathing=EXPORTS/'Risa_ModelOnly_BreathOnly_v2.mp4'
    ...
    write(OUT/'manifest.json',{'primary':str(primary),'breath_only':str(breathing),
        ...
        'breathing_geometry':'At maximum inhalation, raise upper-chest controls and spread sides; shoulder-side top controls raised; center top and waist/lower controls unchanged.',
