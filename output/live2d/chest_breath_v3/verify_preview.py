...
def main():
    ...
    configs=[('speaking','Risa_ModelOnly_ChestBreath_v3.mp4',479,main_indices),
             ('breath_only','Risa_ModelOnly_BreathOnly_v3.mp4',241,[0,30,60,90,120,180,240])]
    result={}
    for label,name,count,indices in configs:
        ...
        result[label]=data
    # Hold the head pose fixed, changing only breath on the new rig.
    # Comparing to v2 would wrongly reject intentional removal of global scale.
